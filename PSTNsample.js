...
document.getElementById("callinghide").style.display = "none"
...
var showUI = function () {
    ...
    document.getElementById("callinghide").style.display = "block";
}

var greetings = {
    index: 0,
    greetings: ["Hello", "Hello", "Hola", "مرحبا", "Bonjour", "Hallo", "Ciao", "你好", "Ola", "こんにちは", "नमस्ते"]
};

setInterval(function () {
    greetings.index++;
    if (greetings.index >= greetings.greetings.length) {
        greetings.index = 0;
    }
    $('span#username').text(greetings.greetings[greetings.index] +
        ",   " + global_username);
}, 10000)
...
sinchClient = new SinchClient({
    applicationKey: '7f994fba-5cee-4367-b8c2-75031cedee87',
    capabilities: {
        calling: true
    },
